...
FDot6 fdot6::fromF32(float n) {
  return static_cast<FDot6>(n * 64.0f);
}

FDot6 fdot6::floor(FDot6 n) {
  return n >> 6;
}

FDot6 fdot6::ceil(FDot6 n) {
  return (n + 63) >> 6;
}

FDot6 fdot6::round(FDot6 n) {
  return (n + 32) >> 6;
}
...
FDot8 fdot8::fromFdot16(FDot16 x) {
  return (x + 0x80) >> 8;
}
...
std::int32_t fdot16::ceilToI32(FDot16 x) {
  return (x + one - 1) >> 16;
}

std::int32_t fdot16::roundToI32(FDot16 x) {
  return (x + half) >> 16;
}

FDot16 fdot16::mul(FDot16 a, FDot16 b) {
  return static_cast<FDot16>((static_cast<std::int64_t>(a) * static_cast<std::int64_t>(b)) >>
                            16);
}
