...
[[nodiscard]] inline std::array<std::int32_t, 8> i32x8Blend(
    const std::array<std::int32_t, 8>& mask,
...
[[nodiscard]] inline std::array<float, 8> i32x8ToF32(
...
[[nodiscard]] inline std::array<std::int32_t, 8> i32x8Mul(
    const std::array<std::int32_t, 8>& lhs,
    const std::array<std::int32_t, 8>& rhs) {
  std::array<std::int32_t, 8> out{};
  for (std::size_t i = 0; i < out.size(); ++i) {
...
[[nodiscard]] inline std::array<std::int32_t, 8> i32x8And(
    const std::array<std::int32_t, 8>& lhs,
    const std::array<std::int32_t, 8>& rhs) {
  std::array<std::int32_t, 8> out{};
  for (std::size_t i = 0; i < out.size(); ++i) {
...
[[nodiscard]] inline std::array<std::int32_t, 8> i32x8Or(
    const std::array<std::int32_t, 8>& lhs,
    const std::array<std::int32_t, 8>& rhs) {
  std::array<std::int32_t, 8> out{};
  for (std::size_t i = 0; i < out.size(); ++i) {
...
[[nodiscard]] inline std::array<std::int32_t, 8> i32x8Xor(
    const std::array<std::int32_t, 8>& lhs,
    const std::array<std::int32_t, 8>& rhs) {
  std::array<std::int32_t, 8> out{};
  for (std::size_t i = 0; i < out.size(); ++i) {
