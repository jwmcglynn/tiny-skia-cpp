...
TEST(BlendModeTest, ToStageMapping) {
  ...
  for (const auto& tc : {
           ...
           StageCase{tiny_skia::BlendMode::Destination,
                     tiny_skia::pipeline::Stage::MoveDestinationToSource,
                     "destination"},
           StageCase{tiny_skia::BlendMode::SourceOver,
                     tiny_skia::pipeline::Stage::SourceOver,
                     "sourceOver"},
           StageCase{tiny_skia::BlendMode::DestinationOver,
                     tiny_skia::pipeline::Stage::DestinationOver,
                     "destinationOver"},
           StageCase{tiny_skia::BlendMode::SourceIn,
                     tiny_skia::pipeline::Stage::SourceIn,
                     "sourceIn"},
           StageCase{tiny_skia::BlendMode::DestinationIn,
                     tiny_skia::pipeline::Stage::DestinationIn,
                     "destinationIn"},
           StageCase{tiny_skia::BlendMode::SourceOut,
                     tiny_skia::pipeline::Stage::SourceOut,
                     "sourceOut"},
           StageCase{tiny_skia::BlendMode::DestinationOut,
                     tiny_skia::pipeline::Stage::DestinationOut,
                     "destinationOut"},
           StageCase{tiny_skia::BlendMode::SourceAtop,
                     tiny_skia::pipeline::Stage::SourceAtop,
                     "sourceAtop"},
           StageCase{tiny_skia::BlendMode::DestinationAtop,
                     tiny_skia::pipeline::Stage::DestinationAtop,
                     "destinationAtop"},
           ...
           StageCase{tiny_skia::BlendMode::Modulate,
                     tiny_skia::pipeline::Stage::Modulate,
                     "modulate"},
           StageCase{tiny_skia::BlendMode::Screen,
                     tiny_skia::pipeline::Stage::Screen,
                     "screen"},
           StageCase{tiny_skia::BlendMode::Overlay,
                     tiny_skia::pipeline::Stage::Overlay,
                     "overlay"},
           StageCase{tiny_skia::BlendMode::Darken,
                     tiny_skia::pipeline::Stage::Darken,
                     "darken"},
           StageCase{tiny_skia::BlendMode::Lighten,
                     tiny_skia::pipeline::Stage::Lighten,
                     "lighten"},
           StageCase{tiny_skia::BlendMode::ColorDodge,
                     tiny_skia::pipeline::Stage::ColorDodge,
                     "colorDodge"},
           StageCase{tiny_skia::BlendMode::ColorBurn,
                     tiny_skia::pipeline::Stage::ColorBurn,
                     "colorBurn"},
           StageCase{tiny_skia::BlendMode::HardLight,
                     tiny_skia::pipeline::Stage::HardLight,
                     "hardLight"},
           StageCase{tiny_skia::BlendMode::SoftLight,
                     tiny_skia::pipeline::Stage::SoftLight,
                     "softLight"},
           StageCase{tiny_skia::BlendMode::Difference,
                     tiny_skia::pipeline::Stage::Difference,
                     "difference"},
           StageCase{tiny_skia::BlendMode::Exclusion,
                     tiny_skia::pipeline::Stage::Exclusion,
                     "exclusion"},
           StageCase{tiny_skia::BlendMode::Multiply,
                     tiny_skia::pipeline::Stage::Multiply,
                     "multiply"},
           StageCase{tiny_skia::BlendMode::Hue, tiny_skia::pipeline::Stage::Hue, "hue"},
           StageCase{tiny_skia::BlendMode::Saturation,
                     tiny_skia::pipeline::Stage::Saturation,
                     "saturation"},
           StageCase{tiny_skia::BlendMode::Color, tiny_skia::pipeline::Stage::Color, "color"},
           StageCase{tiny_skia::BlendMode::Luminosity,
                     tiny_skia::pipeline::Stage::Luminosity,
                     "luminosity"},
       }) {
    SCOPED_TRACE(tc.label);
