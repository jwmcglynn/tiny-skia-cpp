...
void PathBuilder::conicPointsTo(Point pt1, Point pt2, float weight) {
  conicTo(pt1.x, pt1.y, pt2.x, pt2.y, weight);
}
...
void PathBuilder::pushRect(const Rect& rect) {
...
void PathBuilder::pushOval(const Rect& oval) {
...
void PathBuilder::pushPath(const Path& other) {
  lastMoveToIndex_ = points_.size();
